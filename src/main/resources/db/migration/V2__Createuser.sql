...
(
    ...
    CONSTRAINT uc_comment_replies UNIQUE (fk_reply_id, fk_reply_to_id)
)
...
(
    ...
    CONSTRAINT uc_tags_to_articles UNIQUE (fk_tag_id, fk_article_id)
...
CREATE TABLE files(
    ...
    CONSTRAINT fk_author_id FOREIGN KEY (author_id) REFERENCES users (id)
    CONSTRAINT fk_file_group_id FOREIGN KEY (file_group_id) REFERENCES file_groups (id)
)
...
CREATE TABLE file_groups(
    ...
    CONSTRAINT pk_file_groups PRIMARY (id),
)
